    ...
    return (
        ...
        <footer className="bg-white rounded-lg shadow-sm m-4 dark:bg-gray-800">
            <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">developed by <a href="https://www.facebook.com/profile.php?id=100010796496004" className="hover:underline">ALI AHMED</a>in {Date().getFullYear()} <a href="https://www.facebook.com/IEEE.ElShoroukAcademy.SB/?fref=ts" className="hover:underline">IEEE El Shorouk Academy</a></span>
